...
# in that order but need not all be included, and 'all' can be used in 
# place of any particular value. 
# If $showcmd is set, a command which may be used generate the help 
...
sub help {
  ...
  return ($r ? ($showcmd ? $showcmd : '') . $r : 
          "No help available for '$lookup'.\n");
}
