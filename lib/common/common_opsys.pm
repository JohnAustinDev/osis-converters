...
our @SWORD_AUTOGEN_CONFIGS = (
  'DataPath', 'ModDrv', 'Category', 'Companion', 'CompressType', 
  'BlockType', 'BlockCount', 'SourceType', 'Feature', 'Font', 
  'OSISVersion', 'PreferredCSSXHTML', 'GlobalOptionFilter', 'Scope', 
  'SearchOption', 'SwordVersionDate', 'InstallSize', 'MinimumVersion', 
  'CaseSensitiveKeys',
);
