...
our @PROJECT_TYPES = ('bible', 'childrens_bible', 'commentary', 'generic_book');

# Unsupported conversions for each project/module type
our %CONV_NOCANDO = (
  'bible'           => undef,
  'childrens_bible' => [ 'gobible' ],
  'generic_book'    => [ 'gobible' ],
...
# Conversion output subdirectories (MOD will be replaced by $MOD)
...
# Ouput files generated by each conversion (MOD will be replaced by $MOD)
...
sub init() {
  ...
  our ($MAINMOD, $INPD, $SCRIPT_NAME, $HELP, $OSIS2OSIS_PASS);
