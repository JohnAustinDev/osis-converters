...
require("$SCRD/scripts/common/context.pl");
require("$SCRD/scripts/common/defaults.pl");
require("$SCRD/scripts/common/dict.pl");
require("$SCRD/scripts/common/header.pl");
require("$SCRD/scripts/common/image.pl");
require("$SCRD/scripts/common/init.pl");
