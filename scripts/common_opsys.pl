...
@SWORD_AUTOGEN = ('DataPath', 'Category', 'CompressType', 'BlockType', 'SourceType', 'OSISVersion', 'GlobalOptionFilter', 'Scope', 'SearchOption', 'SwordVersionDate', 'InstallSize', 'PreferredCSSXHTML'); # These are SWORD entries which should NOT be set by the user in the config.conf file, because they are autogenerated by osis-converters
