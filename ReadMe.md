...
(multi): These settings may be used multiple times in the control file. All other settings may only be used once, otherwise only the last instance will be effective.
