...
These are available settings in the `config.conf` file. Letters in parenthesis indicate these entry types:(C): Continuable from one line to another using a backslash character.
