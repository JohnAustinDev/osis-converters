...
## Synopsis 
Create JAVA-ME JAR apps from OSIS files. Once Paratext files have been converted to OSIS XML, osis2gobible may utilize Go Bible Creator to produce these apps for feature phones.
